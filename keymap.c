 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI | NAVI | /Space  /       \Enter \  |BackSP|SYMBOL| RAlt |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_COLEMAK_DH] = LAYOUT(
  ...
  KC_LSFT,         KC_Z,   KC_X,    KC_C,    KC_D,    KC_V,  KC_LBRC, KC_RBRC,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                               KC_LALT, KC_LGUI, MO(_NAVI),   KC_SPC, KC_ENT, KC_BSDL, MO(_SYMBOL), KC_RALT
),
/* QWERTY
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  =   |
...
[_GAMING] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_LBRC, KC_RBRC,  KC_N,    KC_M,    KC_DOT,  KC_LEFT, KC_DOWN, KC_RGHT,
                        KC_LALT, KC_LGUI, MO(_NAVI),   KC_SPC, KC_ENT, KC_BSDL, MO(_SYMBOL), KC_RALT
),
/* SYMBOL
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |      |      |   0  |   4  |   5  |   6  |-------.    ,-------|   \  |   ^  |   ~  |   `  |   '  |   !  |
 * |------+------+------+------+------+------| Enter |    |       |------+------+------+------+------+------|
 * |LShift|LCTRL |   .  |   1  |   2  |   3  |-------|    |-------|   _  |   -  |   +  |   /  |   *  |   =  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |OPTION| /Space  /       \Enter \  |BackSP| BASE | RAlt |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_SYMBOL] = LAYOUT(
  _______, _______,  KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS,                   KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR,
  _______, KC_DLR,   KC_PEQL, KC_P7,   KC_P8,   KC_P9,                     KC_AT,   KC_PERC, KC_AMPR, KC_PIPE, KC_HASH, KC_COLN,
  _______, _______,  KC_P0,   KC_P4,   KC_P5,   KC_P6,                     KC_BSLS, KC_CIRC, KC_TILD, KC_GRV,  KC_QUOT, KC_EXLM,
  KC_LSFT, KC_LCTL,  KC_PDOT, KC_P1,   KC_P2,   KC_P3,   KC_ENT, _______,  KC_UNDS, KC_PMNS, KC_PPLS, KC_PSLS, KC_ASTR, KC_PEQL,
...
[_NAVI] = LAYOUT(
  ...
  KC_LSFT, KC_LCTL, _______, KC_DEL,  KC_INS,  KC_PSCR, KC_LT, KC_GT,    KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR,
                           _______, _______, _______, _______, _______,  _______, _______, _______
),
/* OPTIONS
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |      |      |      |      | NKRO |      |-------|    |-------|      |UG TG | OLED |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |SYMBOL| /Space  /       \Enter \  |BackSP| NAVI | RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
  [_OPTIONS] = LAYOUT(
...
/* logic */
static void render_luna(int LUNA_X, int LUNA_Y, uint8_t current_wpm, led_t led_usb_state) {
    /* Sit */
...
static void display_active_layer(led_t led_usb_state) {
    switch (get_highest_layer(layer_state | default_layer_state)) {
        ...
        case _SYMBOL:
            ...
            oled_set_cursor(0, 2);
            if (led_usb_state.caps_lock) {
                oled_write("SYMBOLS & NUMPAD", false);
            } else {
                oled_write("Symbols & numpad", false);
            }
            break;
...
bool oled_task_user(void) {
    ...
    if (is_keyboard_master()) {
        ...
        render_luna(0, 13, current_wpm, led_usb_state);
